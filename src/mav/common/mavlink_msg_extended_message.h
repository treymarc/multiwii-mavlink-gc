 ...
 */
static inline uint16_t mavlink_msg_extended_message_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_extended_message_tt* extended_message)
{
 ...
 */
static inline void mavlink_msg_extended_message_decode(const mavlink_message_t* msg, mavlink_extended_message_tt* extended_message)
{
