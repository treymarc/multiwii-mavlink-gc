...
MAVLINK_SRC_CFLAGS	:=
MAVLINK_SRC_TARGETS	:=  mwgc-$(MWGC_VERSION)
...
$(MAVLINK_SRC_DIR)$(PATH_SEP)$(MAVLINK_SRC_TARGETS): $(MAVLINK_SRC_DIR)$(PATH_SEP)$(MAVLINK_SRC_TARGETS).o  $(SERIAL_SRC_DIR)$(PATH_SEP)serialport.o $(MWI_SRC_DIR)$(PATH_SEP)mwi.o $(MAVLINK_SRC_DIR)$(PATH_SEP)man.o
...
# Objects
#
$(MAVLINK_SRC_DIR)$(PATH_SEP)$(MAVLINK_SRC_TARGETS).o: $(MAVLINK_SRC_DIR)$(PATH_SEP)mwgc.c  
