...
$(MAVLINK_SRC_DIR)$(PATH_SEP)$(MAVLINK_SRC_TARGETS): $(MAVLINK_SRC_DIR)$(PATH_SEP)$(MAVLINK_SRC_OBJECT).o  $(SERIAL_SRC_DIR)$(PATH_SEP)serialport.o $(MWI_SRC_DIR)$(PATH_SEP)mwi.o $(MAVLINK_SRC_DIR)$(PATH_SEP)conf.o
