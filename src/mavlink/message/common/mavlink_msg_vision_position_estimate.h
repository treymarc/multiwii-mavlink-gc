...
static inline uint16_t mavlink_msg_vision_position_estimate_pack(
		...
		uint64_t usec, float x, float y, float z, float roll, float pitch,
		float yaw) {
...
static inline uint16_t mavlink_msg_vision_position_estimate_pack_chan(
		...
		mavlink_message_t* msg, uint64_t usec, float x, float y, float z,
...
static inline uint16_t mavlink_msg_vision_position_estimate_encode(
	...
	return mavlink_msg_vision_position_estimate_pack(system_id, component_id,
			msg, vision_position_estimate->usec, vision_position_estimate->x,
			vision_position_estimate->y, vision_position_estimate->z,
			vision_position_estimate->roll, vision_position_estimate->pitch,
 ...
 */
static inline uint64_t mavlink_msg_vision_position_estimate_get_usec(
 ...
 */
static inline float mavlink_msg_vision_position_estimate_get_x(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_vision_position_estimate_get_y(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_vision_position_estimate_get_z(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_vision_position_estimate_get_pitch(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_vision_position_estimate_get_yaw(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_vision_position_estimate_decode(
		const mavlink_message_t* msg,
