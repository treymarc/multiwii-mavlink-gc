 ...
 */
static inline uint16_t mavlink_msg_attitude_pack(uint8_t system_id,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_attitude_pack_chan(uint8_t system_id,
 ...
 */
static inline uint16_t mavlink_msg_attitude_encode(uint8_t system_id,
		uint8_t component_id, mavlink_message_t* msg,
		const mavlink_attitude_t* attitude) {
	return mavlink_msg_attitude_pack(system_id, component_id, msg,
 ...
 */
static inline uint32_t mavlink_msg_attitude_get_time_boot_ms(
 ...
 */
static inline float mavlink_msg_attitude_get_rollspeed(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_attitude_get_pitchspeed(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_attitude_get_yawspeed(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_attitude_decode(const mavlink_message_t* msg,
