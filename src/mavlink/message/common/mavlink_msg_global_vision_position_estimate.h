...
static inline uint16_t mavlink_msg_global_vision_position_estimate_encode(
	...
	return mavlink_msg_global_vision_position_estimate_pack(system_id,
			component_id, msg, global_vision_position_estimate->usec,
 ...
 */
static inline uint64_t mavlink_msg_global_vision_position_estimate_get_usec(
 ...
 */
static inline float mavlink_msg_global_vision_position_estimate_get_x(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_global_vision_position_estimate_get_y(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_global_vision_position_estimate_get_z(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_global_vision_position_estimate_decode(
		const mavlink_message_t* msg,
