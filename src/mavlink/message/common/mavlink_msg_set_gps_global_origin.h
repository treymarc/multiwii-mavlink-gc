 ...
 */
static inline uint16_t mavlink_msg_set_gps_global_origin_pack(uint8_t system_id,
...
static inline uint16_t mavlink_msg_set_gps_global_origin_pack_chan(
		...
		mavlink_message_t* msg, uint8_t target_system, int32_t latitude,
...
static inline uint16_t mavlink_msg_set_gps_global_origin_encode(
	...
	return mavlink_msg_set_gps_global_origin_pack(system_id, component_id, msg,
			...
			set_gps_global_origin->latitude, set_gps_global_origin->longitude,
 ...
 * @return System ID
 */
static inline uint8_t mavlink_msg_set_gps_global_origin_get_target_system(
 ...
 */
static inline int32_t mavlink_msg_set_gps_global_origin_get_latitude(
		const mavlink_message_t* msg) {
 ...
 * @return global position * 1E7
 */
static inline int32_t mavlink_msg_set_gps_global_origin_get_longitude(
		const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_set_gps_global_origin_get_altitude(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_set_gps_global_origin_decode(
		const mavlink_message_t* msg,
