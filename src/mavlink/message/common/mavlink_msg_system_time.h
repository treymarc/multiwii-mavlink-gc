 ...
 */
static inline uint16_t mavlink_msg_system_time_pack(uint8_t system_id,
		uint8_t component_id, mavlink_message_t* msg, uint64_t time_unix_usec,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_system_time_pack_chan(uint8_t system_id,
...
static inline uint16_t mavlink_msg_system_time_encode(uint8_t system_id,
	...
	return mavlink_msg_system_time_pack(system_id, component_id, msg,
 ...
 */
static inline uint64_t mavlink_msg_system_time_get_time_unix_usec(
 ...
 */
static inline uint32_t mavlink_msg_system_time_get_time_boot_ms(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_system_time_decode(const mavlink_message_t* msg,
