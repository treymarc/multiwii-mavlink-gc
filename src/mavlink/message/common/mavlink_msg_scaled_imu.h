 ...
 */
static inline uint16_t mavlink_msg_scaled_imu_pack(uint8_t system_id,
		uint8_t component_id, mavlink_message_t* msg, uint32_t time_boot_ms,
		int16_t xacc, int16_t yacc, int16_t zacc, int16_t xgyro, int16_t ygyro,
		int16_t zgyro, int16_t xmag, int16_t ymag, int16_t zmag) {
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_scaled_imu_pack_chan(uint8_t system_id,
 ...
 */
static inline uint16_t mavlink_msg_scaled_imu_encode(uint8_t system_id,
		uint8_t component_id, mavlink_message_t* msg,
		const mavlink_scaled_imu_t* scaled_imu) {
	return mavlink_msg_scaled_imu_pack(system_id, component_id, msg,
			scaled_imu->time_boot_ms, scaled_imu->xacc, scaled_imu->yacc,
			scaled_imu->zacc, scaled_imu->xgyro, scaled_imu->ygyro,
			scaled_imu->zgyro, scaled_imu->xmag, scaled_imu->ymag,
			scaled_imu->zmag);
}
 ...
 */
static inline uint32_t mavlink_msg_scaled_imu_get_time_boot_ms(
 ...
 */
static inline int16_t mavlink_msg_scaled_imu_get_xacc(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu_get_yacc(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu_get_zacc(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu_get_xgyro(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu_get_ygyro(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu_get_zgyro(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu_get_xmag(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu_get_ymag(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_imu_get_zmag(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_scaled_imu_decode(const mavlink_message_t* msg,
