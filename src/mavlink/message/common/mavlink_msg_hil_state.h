 ...
 */
static inline uint16_t mavlink_msg_hil_state_pack(uint8_t system_id,
		uint8_t component_id, mavlink_message_t* msg, uint64_t time_usec,
		float roll, float pitch, float yaw, float rollspeed, float pitchspeed,
		float yawspeed, int32_t lat, int32_t lon, int32_t alt, int16_t vx,
		int16_t vy, int16_t vz, int16_t xacc, int16_t yacc, int16_t zacc) {
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_hil_state_pack_chan(uint8_t system_id,
 ...
 */
static inline uint16_t mavlink_msg_hil_state_encode(uint8_t system_id,
		uint8_t component_id, mavlink_message_t* msg,
		const mavlink_hil_state_t* hil_state) {
	return mavlink_msg_hil_state_pack(system_id, component_id, msg,
			hil_state->time_usec, hil_state->roll, hil_state->pitch,
			hil_state->yaw, hil_state->rollspeed, hil_state->pitchspeed,
			hil_state->yawspeed, hil_state->lat, hil_state->lon, hil_state->alt,
			hil_state->vx, hil_state->vy, hil_state->vz, hil_state->xacc,
			hil_state->yacc, hil_state->zacc);
}
 ...
 */
static inline uint64_t mavlink_msg_hil_state_get_time_usec(
 ...
 */
static inline float mavlink_msg_hil_state_get_pitch(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_hil_state_get_rollspeed(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_hil_state_get_pitchspeed(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_hil_state_get_yawspeed(
		const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_hil_state_get_lat(
		const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_hil_state_get_lon(
		const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_hil_state_get_alt(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_hil_state_get_xacc(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_hil_state_get_yacc(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_hil_state_get_zacc(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_hil_state_decode(const mavlink_message_t* msg,
