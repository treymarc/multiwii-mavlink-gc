 ...
 */
static inline uint16_t mavlink_msg_global_position_int_pack(uint8_t system_id,
		uint8_t component_id, mavlink_message_t* msg, uint32_t time_boot_ms,
		int32_t lat, int32_t lon, int32_t alt, int32_t relative_alt, int16_t vx,
...
static inline uint16_t mavlink_msg_global_position_int_pack_chan(
		...
		mavlink_message_t* msg, uint32_t time_boot_ms, int32_t lat, int32_t lon,
		int32_t alt, int32_t relative_alt, int16_t vx, int16_t vy, int16_t vz,
		uint16_t hdg) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[28];
	_mav_put_uint32_t(buf, 0, time_boot_ms);
 ...
 */
static inline uint16_t mavlink_msg_global_position_int_encode(uint8_t system_id,
 ...
 */
static inline uint32_t mavlink_msg_global_position_int_get_time_boot_ms(
 ...
 */
static inline int32_t mavlink_msg_global_position_int_get_lat(
		const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_global_position_int_get_lon(
		const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_global_position_int_get_alt(
		const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_global_position_int_get_relative_alt(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_global_position_int_get_vx(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_global_position_int_get_vy(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_global_position_int_get_vz(
		const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_global_position_int_get_hdg(
		const mavlink_message_t* msg) {
