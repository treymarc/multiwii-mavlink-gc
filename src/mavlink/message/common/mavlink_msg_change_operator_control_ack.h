...
static inline uint16_t mavlink_msg_change_operator_control_ack_pack_chan(
		...
		mavlink_message_t* msg, uint8_t gcs_system_id, uint8_t control_request,
		uint8_t ack) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[3];
	_mav_put_uint8_t(buf, 0, gcs_system_id);
...
static inline uint16_t mavlink_msg_change_operator_control_ack_encode(
	...
	return mavlink_msg_change_operator_control_ack_pack(system_id, component_id,
			msg, change_operator_control_ack->gcs_system_id,
 ...
 */
static inline uint8_t mavlink_msg_change_operator_control_ack_get_gcs_system_id(
 ...
 */
static inline uint8_t mavlink_msg_change_operator_control_ack_get_control_request(
		const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_change_operator_control_ack_get_ack(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_change_operator_control_ack_decode(
		const mavlink_message_t* msg,
