...
static inline uint16_t mavlink_msg_global_position_setpoint_int_pack(
		...
		uint8_t coordinate_frame, int32_t latitude, int32_t longitude,
		int32_t altitude, int16_t yaw) {
...
static inline uint16_t mavlink_msg_global_position_setpoint_int_pack_chan(
		...
		mavlink_message_t* msg, uint8_t coordinate_frame, int32_t latitude,
		int32_t longitude, int32_t altitude, int16_t yaw) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[15];
	_mav_put_int32_t(buf, 0, latitude);
	_mav_put_int32_t(buf, 4, longitude);
...
static inline uint16_t mavlink_msg_global_position_setpoint_int_encode(
	...
	return mavlink_msg_global_position_setpoint_int_pack(system_id,
			component_id, msg, global_position_setpoint_int->coordinate_frame,
 ...
 */
static inline uint8_t mavlink_msg_global_position_setpoint_int_get_coordinate_frame(
 ...
 */
static inline int32_t mavlink_msg_global_position_setpoint_int_get_latitude(
		const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_global_position_setpoint_int_get_longitude(
		const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_global_position_setpoint_int_get_altitude(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_global_position_setpoint_int_get_yaw(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_global_position_setpoint_int_decode(
		const mavlink_message_t* msg,
		mavlink_global_position_setpoint_int_t* global_position_setpoint_int) {
