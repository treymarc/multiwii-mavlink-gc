...
static inline uint16_t mavlink_msg_roll_pitch_yaw_speed_thrust_setpoint_pack(
		...
		uint32_t time_boot_ms, float roll_speed, float pitch_speed,
		float yaw_speed, float thrust) {
...
static inline uint16_t mavlink_msg_roll_pitch_yaw_speed_thrust_setpoint_pack_chan(
		...
		mavlink_message_t* msg, uint32_t time_boot_ms, float roll_speed,
...
static inline uint16_t mavlink_msg_roll_pitch_yaw_speed_thrust_setpoint_encode(
	...
	return mavlink_msg_roll_pitch_yaw_speed_thrust_setpoint_pack(system_id,
			component_id, msg,
 ...
 */
static inline uint32_t mavlink_msg_roll_pitch_yaw_speed_thrust_setpoint_get_time_boot_ms(
 ...
 */
static inline float mavlink_msg_roll_pitch_yaw_speed_thrust_setpoint_get_roll_speed(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_roll_pitch_yaw_speed_thrust_setpoint_get_pitch_speed(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_roll_pitch_yaw_speed_thrust_setpoint_get_yaw_speed(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_roll_pitch_yaw_speed_thrust_setpoint_decode(
		const mavlink_message_t* msg,
		mavlink_roll_pitch_yaw_speed_thrust_setpoint_t* roll_pitch_yaw_speed_thrust_setpoint) {
