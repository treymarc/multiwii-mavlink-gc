 ...
 */
static inline uint16_t mavlink_msg_named_value_int_pack(uint8_t system_id,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_named_value_int_pack_chan(uint8_t system_id,
 ...
 */
static inline uint16_t mavlink_msg_named_value_int_encode(uint8_t system_id,
 ...
 */
static inline uint32_t mavlink_msg_named_value_int_get_time_boot_ms(
 ...
 */
static inline uint16_t mavlink_msg_named_value_int_get_name(
 ...
 */
static inline int32_t mavlink_msg_named_value_int_get_value(
		const mavlink_message_t* msg) {
