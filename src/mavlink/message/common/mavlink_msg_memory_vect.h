 ...
 */
static inline uint16_t mavlink_msg_memory_vect_pack(uint8_t system_id,
		uint8_t component_id, mavlink_message_t* msg, uint16_t address,
		uint8_t ver, uint8_t type, const int8_t *value) {
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_memory_vect_pack_chan(uint8_t system_id,
 ...
 */
static inline uint16_t mavlink_msg_memory_vect_encode(uint8_t system_id,
		uint8_t component_id, mavlink_message_t* msg,
		const mavlink_memory_vect_t* memory_vect) {
	return mavlink_msg_memory_vect_pack(system_id, component_id, msg,
			memory_vect->address, memory_vect->ver, memory_vect->type,
			memory_vect->value);
}
 ...
 */
static inline uint16_t mavlink_msg_memory_vect_get_address(
 ...
 */
static inline uint8_t mavlink_msg_memory_vect_get_type(
		const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_memory_vect_get_value(
 ...
 */
static inline void mavlink_msg_memory_vect_decode(const mavlink_message_t* msg,
