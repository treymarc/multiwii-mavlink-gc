...
static inline uint16_t mavlink_msg_set_local_position_setpoint_encode(
	...
	return mavlink_msg_set_local_position_setpoint_pack(system_id, component_id,
			msg, set_local_position_setpoint->target_system,
			set_local_position_setpoint->target_component,
			set_local_position_setpoint->coordinate_frame,
			set_local_position_setpoint->x, set_local_position_setpoint->y,
			set_local_position_setpoint->z, set_local_position_setpoint->yaw);
}
 ...
 * @return System ID
 */
static inline uint8_t mavlink_msg_set_local_position_setpoint_get_target_system(
 ...
 * @return Component ID
 */
static inline uint8_t mavlink_msg_set_local_position_setpoint_get_target_component(
		const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_set_local_position_setpoint_get_coordinate_frame(
		const mavlink_message_t* msg) {
 ...
 * @return x position
 */
static inline float mavlink_msg_set_local_position_setpoint_get_x(
		const mavlink_message_t* msg) {
 ...
 * @return y position
 */
static inline float mavlink_msg_set_local_position_setpoint_get_y(
		const mavlink_message_t* msg) {
 ...
 * @return z position
 */
static inline float mavlink_msg_set_local_position_setpoint_get_z(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_local_position_setpoint_get_yaw(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_set_local_position_setpoint_decode(
		const mavlink_message_t* msg,
