 ...
 */
static inline uint16_t mavlink_msg_scaled_pressure_pack(uint8_t system_id,
		uint8_t component_id, mavlink_message_t* msg, uint32_t time_boot_ms,
		float press_abs, float press_diff, int16_t temperature) {
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_scaled_pressure_pack_chan(uint8_t system_id,
 ...
 */
static inline uint16_t mavlink_msg_scaled_pressure_encode(uint8_t system_id,
	...
	return mavlink_msg_scaled_pressure_pack(system_id, component_id, msg,
			scaled_pressure->time_boot_ms, scaled_pressure->press_abs,
 ...
 */
static inline uint32_t mavlink_msg_scaled_pressure_get_time_boot_ms(
 ...
 */
static inline float mavlink_msg_scaled_pressure_get_press_abs(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_scaled_pressure_get_press_diff(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_scaled_pressure_get_temperature(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_scaled_pressure_decode(
		const mavlink_message_t* msg,
