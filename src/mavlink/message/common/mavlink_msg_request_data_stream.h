 ...
 */
static inline uint16_t mavlink_msg_request_data_stream_pack(uint8_t system_id,
 ...
 */
static inline uint16_t mavlink_msg_request_data_stream_encode(uint8_t system_id,
 ...
 */
static inline uint8_t mavlink_msg_request_data_stream_get_target_system(
 ...
 * @return The target requested to send the message stream.
 */
static inline uint8_t mavlink_msg_request_data_stream_get_target_component(
		const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_request_data_stream_get_req_stream_id(
		const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_request_data_stream_get_req_message_rate(
		const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_request_data_stream_get_start_stop(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_request_data_stream_decode(
		const mavlink_message_t* msg,
