 ...
 */
static inline uint16_t mavlink_msg_param_request_read_pack(uint8_t system_id,
		uint8_t component_id, mavlink_message_t* msg, uint8_t target_system,
		uint8_t target_component, const char *param_id, int16_t param_index) {
 ...
 */
static inline uint16_t mavlink_msg_param_request_read_encode(uint8_t system_id,
	...
	return mavlink_msg_param_request_read_pack(system_id, component_id, msg,
			...
			param_request_read->target_component, param_request_read->param_id,
 ...
 * @return System ID
 */
static inline uint8_t mavlink_msg_param_request_read_get_target_system(
 ...
 * @return Component ID
 */
static inline uint8_t mavlink_msg_param_request_read_get_target_component(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_param_request_read_get_param_index(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_param_request_read_decode(
		const mavlink_message_t* msg,
