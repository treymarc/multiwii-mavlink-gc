 ...
 */
static inline uint16_t mavlink_msg_sys_status_pack(uint8_t system_id,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_sys_status_pack_chan(uint8_t system_id,
	...
	msg->msgid = MAVLINK_MSG_ID_SYS_STATUS;
	return mavlink_finalize_message_chan(msg, system_id, component_id, chan, 31,
			124);
}
 ...
 */
static inline uint16_t mavlink_msg_sys_status_encode(uint8_t system_id,
		uint8_t component_id, mavlink_message_t* msg,
 ...
 */
static inline uint32_t mavlink_msg_sys_status_get_onboard_control_sensors_present(
 ...
 */
static inline uint32_t mavlink_msg_sys_status_get_onboard_control_sensors_health(
		const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_sys_status_get_load(
		const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_sys_status_get_voltage_battery(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_sys_status_get_current_battery(
		const mavlink_message_t* msg) {
 ...
 */
static inline int8_t mavlink_msg_sys_status_get_battery_remaining(
		const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_sys_status_get_drop_rate_comm(
		const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_sys_status_get_errors_comm(
		const mavlink_message_t* msg) {
 ...
 */
static inline uint16_t mavlink_msg_sys_status_get_errors_count1(
		const mavlink_message_t* msg) {
 ...
 * @return Autopilot-specific errors
 */
static inline uint16_t mavlink_msg_sys_status_get_errors_count2(
		const mavlink_message_t* msg) {
 ...
 * @return Autopilot-specific errors
 */
static inline uint16_t mavlink_msg_sys_status_get_errors_count3(
		const mavlink_message_t* msg) {
 ...
 * @return Autopilot-specific errors
 */
static inline uint16_t mavlink_msg_sys_status_get_errors_count4(
		const mavlink_message_t* msg) {
