 ...
 */
static inline uint16_t mavlink_msg_param_request_list_pack(uint8_t system_id,
 ...
 */
static inline uint16_t mavlink_msg_param_request_list_encode(uint8_t system_id,
 ...
 * @return System ID
 */
static inline uint8_t mavlink_msg_param_request_list_get_target_system(
 ...
 * @return Component ID
 */
static inline uint8_t mavlink_msg_param_request_list_get_target_component(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_param_request_list_decode(
		const mavlink_message_t* msg,
