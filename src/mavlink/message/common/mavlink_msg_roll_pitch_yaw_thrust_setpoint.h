...
static inline uint16_t mavlink_msg_roll_pitch_yaw_thrust_setpoint_pack_chan(
		...
		mavlink_message_t* msg, uint32_t time_boot_ms, float roll, float pitch,
...
static inline uint16_t mavlink_msg_roll_pitch_yaw_thrust_setpoint_encode(
	...
	return mavlink_msg_roll_pitch_yaw_thrust_setpoint_pack(system_id,
			component_id, msg, roll_pitch_yaw_thrust_setpoint->time_boot_ms,
 ...
 */
static inline uint32_t mavlink_msg_roll_pitch_yaw_thrust_setpoint_get_time_boot_ms(
 ...
 */
static inline float mavlink_msg_roll_pitch_yaw_thrust_setpoint_get_roll(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_roll_pitch_yaw_thrust_setpoint_get_pitch(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_roll_pitch_yaw_thrust_setpoint_get_yaw(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_roll_pitch_yaw_thrust_setpoint_get_thrust(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_roll_pitch_yaw_thrust_setpoint_decode(
		const mavlink_message_t* msg,
		mavlink_roll_pitch_yaw_thrust_setpoint_t* roll_pitch_yaw_thrust_setpoint) {
