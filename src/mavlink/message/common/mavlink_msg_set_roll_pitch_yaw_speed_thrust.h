...
static inline uint16_t mavlink_msg_set_roll_pitch_yaw_speed_thrust_pack(
		...
		uint8_t target_system, uint8_t target_component, float roll_speed,
		float pitch_speed, float yaw_speed, float thrust) {
...
static inline uint16_t mavlink_msg_set_roll_pitch_yaw_speed_thrust_encode(
	...
	return mavlink_msg_set_roll_pitch_yaw_speed_thrust_pack(system_id,
			component_id, msg, set_roll_pitch_yaw_speed_thrust->target_system,
 ...
 * @return System ID
 */
static inline uint8_t mavlink_msg_set_roll_pitch_yaw_speed_thrust_get_target_system(
 ...
 * @return Component ID
 */
static inline uint8_t mavlink_msg_set_roll_pitch_yaw_speed_thrust_get_target_component(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_roll_pitch_yaw_speed_thrust_get_roll_speed(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_roll_pitch_yaw_speed_thrust_get_pitch_speed(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_roll_pitch_yaw_speed_thrust_get_yaw_speed(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_roll_pitch_yaw_speed_thrust_get_thrust(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_set_roll_pitch_yaw_speed_thrust_decode(
		const mavlink_message_t* msg,
		mavlink_set_roll_pitch_yaw_speed_thrust_t* set_roll_pitch_yaw_speed_thrust) {
