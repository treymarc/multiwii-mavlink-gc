 ...
 */
static inline uint16_t mavlink_msg_named_value_float_pack(uint8_t system_id,
...
static inline uint16_t mavlink_msg_named_value_float_pack_chan(
		...
		mavlink_message_t* msg, uint32_t time_boot_ms, const char *name,
		float value) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[18];
	_mav_put_uint32_t(buf, 0, time_boot_ms);
 ...
 */
static inline uint16_t mavlink_msg_named_value_float_encode(uint8_t system_id,
	...
	return mavlink_msg_named_value_float_pack(system_id, component_id, msg,
			named_value_float->time_boot_ms, named_value_float->name,
 ...
 */
static inline uint32_t mavlink_msg_named_value_float_get_time_boot_ms(
 ...
 */
static inline uint16_t mavlink_msg_named_value_float_get_name(
 ...
 */
static inline float mavlink_msg_named_value_float_get_value(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_named_value_float_decode(
		const mavlink_message_t* msg,
