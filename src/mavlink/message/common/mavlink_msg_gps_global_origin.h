 ...
 */
static inline uint16_t mavlink_msg_gps_global_origin_pack(uint8_t system_id,
		uint8_t component_id, mavlink_message_t* msg, int32_t latitude,
...
static inline uint16_t mavlink_msg_gps_global_origin_pack_chan(
		...
		mavlink_message_t* msg, int32_t latitude, int32_t longitude,
		int32_t altitude) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[12];
	_mav_put_int32_t(buf, 0, latitude);
 ...
 */
static inline uint16_t mavlink_msg_gps_global_origin_encode(uint8_t system_id,
	...
	return mavlink_msg_gps_global_origin_pack(system_id, component_id, msg,
			gps_global_origin->latitude, gps_global_origin->longitude,
 ...
 */
static inline int32_t mavlink_msg_gps_global_origin_get_latitude(
 ...
 */
static inline int32_t mavlink_msg_gps_global_origin_get_longitude(
		const mavlink_message_t* msg) {
 ...
 */
static inline int32_t mavlink_msg_gps_global_origin_get_altitude(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_gps_global_origin_decode(
		const mavlink_message_t* msg,
