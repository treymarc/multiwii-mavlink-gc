...
static inline uint16_t mavlink_msg_set_roll_pitch_yaw_thrust_pack(
		...
		uint8_t target_system, uint8_t target_component, float roll,
		float pitch, float yaw, float thrust) {
...
static inline uint16_t mavlink_msg_set_roll_pitch_yaw_thrust_encode(
	...
	return mavlink_msg_set_roll_pitch_yaw_thrust_pack(system_id, component_id,
			msg, set_roll_pitch_yaw_thrust->target_system,
			set_roll_pitch_yaw_thrust->target_component,
			set_roll_pitch_yaw_thrust->roll, set_roll_pitch_yaw_thrust->pitch,
			set_roll_pitch_yaw_thrust->yaw, set_roll_pitch_yaw_thrust->thrust);
}
 ...
 * @return System ID
 */
static inline uint8_t mavlink_msg_set_roll_pitch_yaw_thrust_get_target_system(
 ...
 * @return Component ID
 */
static inline uint8_t mavlink_msg_set_roll_pitch_yaw_thrust_get_target_component(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_roll_pitch_yaw_thrust_get_roll(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_roll_pitch_yaw_thrust_get_pitch(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_roll_pitch_yaw_thrust_get_yaw(
		const mavlink_message_t* msg) {
 ...
 */
static inline float mavlink_msg_set_roll_pitch_yaw_thrust_get_thrust(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_set_roll_pitch_yaw_thrust_decode(
		const mavlink_message_t* msg,
