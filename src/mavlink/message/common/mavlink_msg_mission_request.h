 ...
 */
static inline uint16_t mavlink_msg_mission_request_pack(uint8_t system_id,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_mission_request_pack_chan(uint8_t system_id,
 ...
 */
static inline uint16_t mavlink_msg_mission_request_encode(uint8_t system_id,
 ...
 * @return System ID
 */
static inline uint8_t mavlink_msg_mission_request_get_target_system(
 ...
 * @return Component ID
 */
static inline uint8_t mavlink_msg_mission_request_get_target_component(
		const mavlink_message_t* msg) {
 ...
 * @return Sequence
 */
static inline uint16_t mavlink_msg_mission_request_get_seq(
		const mavlink_message_t* msg) {
