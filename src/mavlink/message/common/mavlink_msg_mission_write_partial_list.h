...
static inline uint16_t mavlink_msg_mission_write_partial_list_encode(
	...
	return mavlink_msg_mission_write_partial_list_pack(system_id, component_id,
			msg, mission_write_partial_list->target_system,
 ...
 * @return System ID
 */
static inline uint8_t mavlink_msg_mission_write_partial_list_get_target_system(
 ...
 * @return Component ID
 */
static inline uint8_t mavlink_msg_mission_write_partial_list_get_target_component(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_mission_write_partial_list_get_start_index(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_mission_write_partial_list_get_end_index(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_mission_write_partial_list_decode(
		const mavlink_message_t* msg,
