...
#define MAVLINK_MESSAGE_INFO_EXTENDED_MESSAGE { \
	"EXTENDED_MESSAGE", \
	3, \
	{  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_extended_message_tt, target_system) }, \
         { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 1, offsetof(mavlink_extended_message_tt, target_component) }, \
         { "protocol_flags", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_extended_message_tt, protocol_flags) }, \
         } \
}
 ...
 */
static inline uint16_t mavlink_msg_extended_message_pack(uint8_t system_id,
		uint8_t component_id, mavlink_message_t* msg, uint8_t target_system,
		uint8_t target_component, uint8_t protocol_flags) {
...
#else
	mavlink_extended_message_tt packet;
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_extended_message_pack_chan(uint8_t system_id,
 ...
 */
static inline uint16_t mavlink_msg_extended_message_encode(uint8_t system_id,
		uint8_t component_id, mavlink_message_t* msg,
		const mavlink_extended_message_tt* extended_message) {
	return mavlink_msg_extended_message_pack(system_id, component_id, msg,
			extended_message->target_system, extended_message->target_component,
			extended_message->protocol_flags);
}
 ...
 */
static inline uint8_t mavlink_msg_extended_message_get_target_system(
 ...
 */
static inline uint8_t mavlink_msg_extended_message_get_target_component(
		const mavlink_message_t* msg) {
 ...
 */
static inline uint8_t mavlink_msg_extended_message_get_protocol_flags(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_extended_message_decode(
		const mavlink_message_t* msg,
		mavlink_extended_message_tt* extended_message) {
