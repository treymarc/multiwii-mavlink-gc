 ...
 */
static inline uint16_t mavlink_msg_raw_imu_pack(uint8_t system_id,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_raw_imu_pack_chan(uint8_t system_id,
 ...
 */
static inline uint16_t mavlink_msg_raw_imu_encode(uint8_t system_id,
		uint8_t component_id, mavlink_message_t* msg,
		const mavlink_raw_imu_t* raw_imu) {
	return mavlink_msg_raw_imu_pack(system_id, component_id, msg,
			raw_imu->time_usec, raw_imu->xacc, raw_imu->yacc, raw_imu->zacc,
			raw_imu->xgyro, raw_imu->ygyro, raw_imu->zgyro, raw_imu->xmag,
			raw_imu->ymag, raw_imu->zmag);
}
 ...
 */
static inline uint64_t mavlink_msg_raw_imu_get_time_usec(
 ...
 */
static inline int16_t mavlink_msg_raw_imu_get_xgyro(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_raw_imu_get_ygyro(
		const mavlink_message_t* msg) {
 ...
 */
static inline int16_t mavlink_msg_raw_imu_get_zgyro(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_raw_imu_decode(const mavlink_message_t* msg,
