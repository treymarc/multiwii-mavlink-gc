 ...
 */
static inline uint16_t mavlink_msg_local_position_ned_pack(uint8_t system_id,
...
static inline uint16_t mavlink_msg_local_position_ned_pack_chan(
		...
		mavlink_message_t* msg, uint32_t time_boot_ms, float x, float y,
 ...
 */
static inline uint16_t mavlink_msg_local_position_ned_encode(uint8_t system_id,
	...
	return mavlink_msg_local_position_ned_pack(system_id, component_id, msg,
			local_position_ned->time_boot_ms, local_position_ned->x,
			local_position_ned->y, local_position_ned->z,
			local_position_ned->vx, local_position_ned->vy,
 ...
 */
static inline uint32_t mavlink_msg_local_position_ned_get_time_boot_ms(
 ...
 * @return X Position
 */
static inline float mavlink_msg_local_position_ned_get_x(
		const mavlink_message_t* msg) {
 ...
 * @return Y Position
 */
static inline float mavlink_msg_local_position_ned_get_y(
		const mavlink_message_t* msg) {
 ...
 * @return Z Position
 */
static inline float mavlink_msg_local_position_ned_get_z(
		const mavlink_message_t* msg) {
 ...
 * @return X Speed
 */
static inline float mavlink_msg_local_position_ned_get_vx(
		const mavlink_message_t* msg) {
 ...
 * @return Y Speed
 */
static inline float mavlink_msg_local_position_ned_get_vy(
		const mavlink_message_t* msg) {
 ...
 * @return Z Speed
 */
static inline float mavlink_msg_local_position_ned_get_vz(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_local_position_ned_decode(
		const mavlink_message_t* msg,
