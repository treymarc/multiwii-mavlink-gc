 ...
 */
static inline uint16_t mavlink_msg_mission_set_current_pack(uint8_t system_id,
 ...
 */
static inline uint16_t mavlink_msg_mission_set_current_encode(uint8_t system_id,
	...
	return mavlink_msg_mission_set_current_pack(system_id, component_id, msg,
			...
			mission_set_current->target_component, mission_set_current->seq);
}
 ...
 * @return System ID
 */
static inline uint8_t mavlink_msg_mission_set_current_get_target_system(
 ...
 * @return Component ID
 */
static inline uint8_t mavlink_msg_mission_set_current_get_target_component(
		const mavlink_message_t* msg) {
 ...
 * @return Sequence
 */
static inline uint16_t mavlink_msg_mission_set_current_get_seq(
		const mavlink_message_t* msg) {
 ...
 */
static inline void mavlink_msg_mission_set_current_decode(
		const mavlink_message_t* msg,
